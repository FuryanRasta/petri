...
func init() {
	proto.RegisterType((*MsgAddSuper)(nil), "petri.guardian.MsgAddSuper")
	proto.RegisterType((*MsgAddSuperResponse)(nil), "petri.guardian.MsgAddSuperResponse")
	proto.RegisterType((*MsgDeleteSuper)(nil), "petri.guardian.MsgDeleteSuper")
	proto.RegisterType((*MsgDeleteSuperResponse)(nil), "petri.guardian.MsgDeleteSuperResponse")
}
...
func (c *msgClient) AddSuper(ctx context.Context, in *MsgAddSuper, opts ...grpc.CallOption) (*MsgAddSuperResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.guardian.Msg/AddSuper", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteSuper(ctx context.Context, in *MsgDeleteSuper, opts ...grpc.CallOption) (*MsgDeleteSuperResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.guardian.Msg/DeleteSuper", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddSuper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.guardian.Msg/AddSuper",
	}
...
func _Msg_DeleteSuper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.guardian.Msg/DeleteSuper",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.guardian.Msg",
